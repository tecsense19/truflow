...
$on_a_account = isset($userData) ? $userData['on_a_account'] : '';
// print_r($country);
// die();
?>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-xl">
                ...
                <form method="post" id="user_form" action="<?php echo base_url() ?>admin/user/save"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" data-val="true"
                                        data-val-required="First name is required." id="first_name" name="first_name"
                                        type="text" value="<?php echo $first_name; ?>" />
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" data-val="true" readonly id="email" name="email"
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select name="company_name" id="company_name" data-val="true"
                                        ...
                                        <option value="<?php echo $company1['company_name'] ?>"
                                            <?php echo ($company_name == $company1['company_name']) ? 'selected' : ''; ?>>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select name="country" id="country" class="form-control"
                                        ...
                                        <option value="<?php echo $country1['label'] ?>"
                                            <?php echo ($country == $country1['label']) ? 'selected' : ''; ?>>
                                            <?= $country1['label'] ?>
                                        </option>
                                        <?php endforeach; ?>
                                        <?php }?>
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" data-val="true"
                                        data-val-required="Street Address 1 is required." id="address_1"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" data-val="true"
                                        data-val-required="Street Address 2 is required." id="address_2"
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" data-val="true" data-val-required="City is required."
                                        id="city" name="city" type="text" value="<?php echo $city; ?>" />
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" data-val="true"
                                        data-val-required="Zip/Postal code required." id="zipcode" name="zipcode"
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" data-val="true" data-val-required="phone is required."
                                        id="phone" name="phone" type="text" value="<?php echo $phone; ?>" />
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" data-val="true"
                                        data-val-required="Mobile Number is required." id="mobile" name="mobile"
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" data-val="true" data-val-required="Fax is required."
                    ...
                    <input class="form-control" data-val="true" id="user_role" name="user_role" type="hidden"
                        value="user" />
                    <input class="form-control" data-val="true" id="user_id" name="user_id" type="hidden"

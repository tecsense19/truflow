        ...
        <div class="row align-items-center">
            <div class="col-lg-12 mb-5">
                <div class="about_content">
                    ...
                    <p>We are Truflow Hydraulic Hose and Fittings ("Company," "we," "us," "our"), a company registered in Australia at 29 Dowd Street, Welshpool, Western Australia 6106.</p>
                    ...
                    <p>We are the owner or the licencee of all intellectual property rights in our Services, including all source code, databases, functionality, software, website designs, audio, video, text, photographs, and graphics in the Services (collectively, the "Content"), as well as the trademarks, service marks, and logos contained therein (the "Marks").</p>
                    ...
                    <p><b>access the Services; and</b></p>
                    <p>download or print a copy of any portion of the Content to which you have properly gained access.</p>

                    <p><b>solely for your internal business purpose.</b></p>
                    <p>Except as set out in this section or elsewhere in our Legal Terms, no part of the Services and no Content or Marks may be copied, reproduced, aggregated, republished, uploaded, posted, publicly displayed, encoded, translated, transmitted, distributed, sold, licenced, or otherwise exploited for any commercial purpose whatsoever, without our express prior written permission.</p>
                    <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: admin@truflowhydraulic.com.au. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
                    ...
                    <p><b>You are responsible for what you post or upload: </b></p>
                    ...
                    <p><b>By using the Services, you represent and warrant that: </b></p>
                    <p>(1) you have the legal capacity and you agree to comply with these Legal Terms; </p>
                    <p>(2) you are not a minor in the jurisdiction in which you reside; </p>
                    <p>(3) you will not access the Services through automated or non-human means, whether through a bot, script or otherwise; </p>
                    <p>(4) you will not use the Services for any illegal or unauthorized purpose; and </p>
                    <p>(5) your use of the Services will not violate any applicable law or regulation.</p>
                    ...
                    <p>-  Mastercard</p>
                    <p>-  Stripe</p>
                    <p>You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Services. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be in Australian Dollars.</p>
                    ...
                    <p>Please review our Return Policy posted on the Services prior to making any purchases.</p><br>

                    <h3>7. PROHIBITED ACTIVITIES</h3>
                    <p>You may not access or use the Services for any purpose other than that for which we make the Services available. The Services may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.</p>
                    <p><b>As a user of the Services, you agree not to:</b></p>
                    ...
                    <p>Use the Services as part of any effort to compete with us or otherwise use the Services and/or the Content for any revenue-generating endeavor or commercial enterprise.</p><br>
                    ...
                    <p>You and agree that we may access, store, process, and use any information and personal data that you provide following the terms of the Privacy Policy and your choices (including settings).</p>
                    ...
                    <p>These Legal Terms shall be governed by and defined following the laws of Australia. We and you irrevocably agree that the courts of Western Australia (or if applicable Australia) shall have non-exclucive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>
                    <br>
                    ...
                    <p><b>Australia.</b></p>
                    <p><b>Phone: +61894512204</b></p>
                    <p><b>admin@truflowhydraulic.com.au</b></p>
                </div>
            </div>

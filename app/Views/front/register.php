    ...
    <form method="post" id="category_form" action="<?php echo base_url() ?>register/save" enctype='multipart/form-data'>
      ...
      <div class="col-md-9">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input class="form-control" data-val="true" data-val-required="First name is required." id="first_name"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input class="form-control" data-val="true" data-val-required="Last name is required." id="last_name"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input class="form-control" data-val="true" data-val-required="" id="date_of_birth" name="date_of_birth"
                    type="date" value="" />
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input class="form-control" data-val="true" data-val-required="Email is required." id="email"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input class="form-control" data-val="true" data-val-required="Street Address 1 is required."
                    id="address_1" name="address_1" type="text" value="" />
            </div>
        </div>
        <div class="form-group row">
            <label class="col-md-3 control-label" for="address 2">Street Address 2 :</label>
            <div class="col-md-9">
                <input class="form-control" data-val="true" data-val-required="Street Address 2 is required."
                    id="address_2" name="address_2" type="text" value="" />
            </div>
        </div>
        <div class="form-group row">
            <label class="col-md-3 control-label" for="last_name">City :</label>
            <div class="col-md-9">
                <input class="form-control" data-val="true" data-val-required="City is required." id="city" name="city"
                    type="text" value="" />
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input class="form-control" data-val="true" data-val-required="Zip/Postal code required." id="zipcode"
                    name="zipcode" type="text" value="" />
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input class="form-control" data-val="true" data-val-required="Mobile Number is required." id="mobile"
                    name="mobile" type="text" value="" onkeypress="return isNumber(event)" />
            </div>
        </div>
        <div class="form-group row">
            <label class="col-md-3 control-label" for="Phone">Phone :</label>
            <div class="col-md-9">
                <input class="form-control" data-val="true" data-val-required="phone is required." id="phone"
                    name="phone" type="text" value="" onkeypress="return isNumber(event)" />
            </div>
        </div>
        <div class="form-group row">
            <label class="col-md-3 control-label" for="Fax">Fax :</label>
            <div class="col-md-9">
                <input class="form-control" data-val="true" data-val-required="Fax is required." id="fax" name="fax"
                    type="text" value="" />
            </div>
        </div>
        <h4>Your Password</h4>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input class="form-control" data-val="true" data-val-required="password Number is required."
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input class="form-control" data-val="true" data-val-required="password Number is required."
                    id="c_password" name="c_password" type="password" value="" />
            </div>
        </div>
        ...
        <div class="text-center mb-5">
            ...
            <input type="submit" id="register-button" class="btn btn-default submit_form" value="Register"
        ...
        rules: {
            ...
            mobile: {
                required: function(element) {
                    return $('#phone').val() === ''; // Make mobile required only if phone is empty
                },
                digits: true,
                minlength: 10,
                maxlength: 10
            ...
            // phone: {
            //     required: function(element) {
            //         return $('#mobile').val() === ''; // Make phone required only if mobile is empty
            //     },
            //     digits: true,
            //     minlength: 10,
            //     maxlength: 10

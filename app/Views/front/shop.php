            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="about_heading">
                        <h2 class="breadcrumb-list" style="display: flex;justify-content: center;flex-wrap: wrap;text-transform: capitalize;"><div> <a href="<?php echo base_url() ?>shop"> SHOP </a> </div> </h2>
                    </div>
                </div>
            </div>
        </div>

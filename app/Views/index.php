        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="banner_text">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. A donec velit, et tempor, sit turpis. Ut posuere quisque sagittis leo massa est est felis. Enim diam et nisi, nunc amet pretium.</p>
              <button type="button" class="btn">CALL NOW</button>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="banner_img">
              <img src="<?php echo base_url()?>public/front/images/banner-img.png" alt="banner_img" class="img-fluid">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-6">
            <div class="order_main">
              <div class="blue_border">
                <h4>instant order</h4>
                <p>Type any Fluid Connectors part number and quantity or log in/register an account to type your own part numbers.</p>
          ...
          <div class="col-lg-6">
            <div class="slider">
              <!--<div class="swiper-container">
                ...
                <div class="swiper-button-prev"><i class="fa fa-angle-double-up" aria-hidden="true"></i></div>
                <div class="swiper-button-next"><i class="fa fa-angle-double-down" aria-hidden="true"></i></div>
              </div>-->
              <div class="slider_content">
                <div class="slider_con_img">
                  <img src="<?php echo base_url()?>public/front/images/s1.png" alt="products" class="img-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="lorem_heading text-center">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Adipiscing enim morbi tortor.Lorem ipsum dolor.</p>
        ...
        <div class="col-lg-12">
          <div class="container">
            <div class="owl-carousel-2 owl-carousel owl-theme">
              <div class="item">
                <div class="test_img">
                  <img src="<?php echo base_url()?>public/front/images/client.png" alt="client" class="img-fluid">
                </div>
                <div class="testi_card text-center">
                  ...
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Adipiscing enim morbi tortor.Lorem ipsum dolor sit amet, consectetur adipiscing.Lorem ipsum dolor sit amet,</p>
                </div>
              </div>
              <div class="item">
                <div class="test_img">
